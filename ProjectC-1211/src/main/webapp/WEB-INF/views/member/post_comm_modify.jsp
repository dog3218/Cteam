...
<body>
<h3>게시글 수정</h3>
<form action="update_comm.my" method="post" enctype="multipart/form-data">
	...
	<table>
		<tr>
			...
			<td class='left middle'><select name='subject'>
				...
				<option value='공연후기' ${vo.subject eq '공연후기' ? 'selected' : ""}>공연후기</option>
				<option value='동행구해요' ${vo.subject eq '동행구해요' ? 'selected' : ""}>동행구해요</option>
				<option value='자유' ${vo.subject eq '자유' ? 'selected' : ""}>자유</option>
			</select></td>
		</tr> 
		<tr>
