...
public class BoardDAO_web_GW{
	...
	public int board_insert(BoardVO vo) {
		return sql.insert("board.mapper.board_insert_es", vo);
	}
	...
	public BoardVO board_detail(int no) {
		return sql.selectOne("board.mapper.board_detail", no);
	}
	...
	public int board_delete(int no) {
		return sql.delete("board.mapper.board_delete_es", no);
	}

	/*
	 * public int comment_insert(BoardVO vo) { return sql.insert("board.mapper.",
	 * vo); }
	 * 
	 * public int comment_update(BoardVO vo) { return sql.update("board.mapper.",
	 * vo); }
	 * 
	 * public int comment_delete(int id) { return
	 * sql.update("board.mapper.insert_es", id); }
	 */
