...
<style type="text/css"> 
#login { width: 100%; height: calc(100% - 50%); padding: 50px 0;	float: left; }
...
<body>
	...
	<div style="width: 500px; border: 1px solid #ccc;" class='center'>
		<!-- height:calc(100% - 55%); common.css .center 추가 -->
		<div id='login'>
			<div style="height: 200px">
				<a href='<c:url value="/" />'><img src='imgs/logo_transparent.png' /></a>
			</div>
			<div>
			...
			<!-- onkeypress : keyCode 13번(Enter Key)을 눌렀을 때 go_login() 처리 -->	
					...
					<a class='btn-fill' href="#" onclick="go_join();">회원가입</a>
			</div>
		</div>
	</div>
