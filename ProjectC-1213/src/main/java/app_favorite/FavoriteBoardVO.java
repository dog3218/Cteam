...
public class FavoriteBoardVO {
	...
	entncage, dscntinfo, atpn, homepageurl, advantkinfo, prkplceyn, rdnmadr, lnmadr, latitude, longitude, referencedate, filename, filepath, postdate, writer, on_offline , likemember, target_type;
    private int no, post_able, readcnt, post_id_board ,  post_id_community ;
